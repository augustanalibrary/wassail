<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2014-06-12 08:46:33 MDT */ ?>
...
<body>
	...
	<div id = "login-box" class = "dialog">
	  ...
	  <form method = 'post' action = 'index.php' style = "z-index:100;">
		...
		<td>
		  <input type = "text" name = "username" id = "username"  value = "<?php echo $this->_vars['username']; ?>
